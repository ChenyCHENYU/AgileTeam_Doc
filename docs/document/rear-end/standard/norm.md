...
<DocImage src="rear-end/1.png"/>

<DocImage src="rear-end/2.png"/>
...
<DocImage src="rear-end/3.png"/>

<DocImage src="rear-end/4.png"/>
...
<DocImage src="rear-end/5.png" title="重复接口示栗"/>
...
<DocImage src="rear-end/6.png" title="接口上传插件安装示例"/>
...
<DocImage src="rear-end/7.png" title="接口上传插件配置示例"/>

<DocImage src="rear-end/8.png" title="token说明"/>

<DocImage src="rear-end/9.png" title="Id说明"/>

#### 接口上传管理

确定接口生成时机及方式，通过数据库表自动生成接口完善入参、出参、接口路径推送至 `YAPi` 形成接口，然后进行业务逻辑研发（非强制要求）。接口上传步骤，光标移动至 `contorller` 方法名或者类名右键或者快捷进行接口上传，可参考如下图：

<DocImage src="rear-end/10.png" title="接口上传插件上传示例"/>
...
<DocImage src="rear-end/12.png" />

<DocImage src="rear-end/13.png" />
...
<DocImage src="rear-end/15.png" />

<DocImage src="rear-end/16.png" />

<DocImage src="rear-end/17.png" />

<DocImage src="rear-end/18.png" />

<DocImage src="rear-end/19.png" />
...
<DocImage src="rear-end/20.png" title="CheckStyle-IDEA插件安装"/>
...
<DocImage src="rear-end/21.png" title="配置检查模板"/>

<DocImage src="rear-end/22.png" title="手动检查代码"/>

<DocImage src="rear-end/21.png" title="idea规范检查模板"/>
