...
> 定义：从职业角度，建立以项目经理责任制为核心，对项目实行质量、安全、进度、成本管理的责任保证体系和全面提高项目管理水平设立的重要管理岗位。项目经理是为项目的成功策划和执行负总责的人。
...
> `01-立项申请` | `02-协同平台项目创建` | `03-毛利测算` | `04-技术协议` | `05-商务合同`
...
> `06-项目计划拆解表` | `07-需求设计方案` | `08-架构方案(选型,环境,集成)` | `09-项目启动会ppt` | `10-TEC内审及纪要存档` | `11-项目启动评审及纪要`
...
> `14-禅道项目配置` | `15-禅道任务分配` | `16-组织需求评审及纪要` | `17-组织用例评审及纪要` | `18-各环境及服务器资源信息`
...
> `21-showcase记录单` | `22-提测申请表` | `23-迭代bug当量表` | `24-禅道bug管理` | `25-code-review月度评测报告`
...
> `34-操作使用说明书` | `35-测试报告` | `36-验收评审及存档` | `37-合同节点(里程碑)达成签字确认`
...
> `40-上线报告签章` | `41-验收报告签章` | `42-项目系列文档` | `43-语雀系统性归档`
